					...
					return {
						exports: (function (asmLibraryArg, wasmMemory, wasmTable) {
							...
							return (
								...
								(n[2] = function (a, jh) {
									...
									(-1 == (0 | (Bh = q[(8 + (Ch = (Eh + (jh << 5)) | 0)) >> 2]))
										? ((q[((Kh = Ah) + (Ah = jh << 2)) >> 2] = q[(q[(a + 148) >> 2] + (q[(Ch + 16) >> 2] << 2)) >> 2]),
								...
								(n[3] = function (a, rn, sn, vn, wn) {
									...
									var Bn,
										...
										zn = (function (a) {
											...
											(yn = x(
												x(
													x(u[(4 + ((q[(a + 168) >> 2] + w(rn, 12)) | 0)) >> 2] + u[(xn + q[(a + 284) >> 2]) >> 2]) *
												...
												if (
													...
													for (Ij = (Bj + Ej) | 0, Jj = q[(a + 20) >> 2], zj = Ej; ; ) {
														for (
															...
															(u[(Aj = ((Bj = Dj << 2) + Fj) | 0) >> 2] = u[Aj >> 2] + x(Kj * u[(Bj + Lj) >> 2])),
																(0 | Gj) != (0 | (Dj = (Dj + 1) | 0));
														);
									...
									if (!(q[((a |= 0) + 648) >> 2] || (0 | (Fe = q[(a + 332) >> 2])) < 1))
										for (Ke = ((Ge = q[(a + 336) >> 2]) + w(Fe, 20)) | 0, Fe = q[(a + 424) >> 2], Ie = q[(a + 444) >> 2]; ; ) {
											if (q[Fe >> 2] && !((0 | (He = q[(Ge + 16) >> 2])) < (a = 1)))
												for (
													He <<= 1, Le = q[Ie >> 2];
													(u[(Je = ((a << 2) + Le) | 0) >> 2] = -u[Je >> 2]), (0 | (a = (a + 2) | 0)) < (0 | He);
												);
								...
								(n[11] = function (a, Gl, Pm, Qm, Rm, Sm) {
									...
									if (
										...
										for (
											...
											(Vm = ((Qm = Vm) + 4) | 0),
												0 != (Gl = 1e9 * (Gl - ((q[Qm >> 2] = Tm = (Gl < 4294967296) & (0 <= Gl) ? ~~Gl >>> 0 : 0) >>> 0)));
										);
										...
										if (
											(0 | (Qm = (((_m - (102 == (0 | on) ? 0 : Vm)) | 0) - ((103 == (0 | on)) & (0 != (0 | _m)))) | 0)) <
											((w((Tm - bn) >> 2, 9) + -9) | 0)
										) {
											if (
											...
											if (
												...
												if (1e9 <= (q[Zm >> 2] = Qm = (Qm + Wm) | 0) >>> 0)
													for (
														;
														(Zm = (Zm + -4) | (q[Zm >> 2] = 0)) >>> 0 < Um >>> 0 && (q[(Um = (Um + -4) | 0) >> 2] = 0),
															(Qm = (q[Zm >> 2] + 1) | 0),
										...
										if (103 != (0 | on)) Ym = 8 & Rm;
											...
											((_m = (((Qm = ((0 | Vm) < (0 | (Tm = _m || 1))) & (-5 < (0 | Vm))) ? -1 ^ Vm : -1) + Tm) | 0),
											(Sm = ((Qm ? -1 : -2) + Sm) | 0),
											!(Ym = 8 & Rm))
										) {
										...
										if (
											...
											p: if (!(((0 | _m) < 1) | (an >>> 0 <= Um >>> 0)))
												for (;;) {
													if ((16 + Xm) >>> 0 < (Tm = ga(q[Um >> 2], 0, Vm)) >>> 0)
														for (; (o[0 | (Tm = (Tm + -1) | 0)] = 48), (16 + Xm) >>> 0 < Tm >>> 0; );
													if (
														(Z(a, Tm, (0 | _m) < 9 ? _m : 9), (_m = (_m + -9) | 0), an >>> 0 <= (Um = (Um + 4) | 0) >>> 0)
													)
														break p;
													if (!(0 < (0 | _m))) break;
												}
											...
											q: if (!((0 | _m) < 0))
												for (Sm = cn ? an : (Um + 4) | 0, Qm = (16 + Xm) | 8, bn = (16 + Xm) | 9, Vm = Um; ; ) {
													if (
														((0 | bn) == (0 | (Tm = ga(q[Vm >> 2], 0, bn))) && ((o[(24 + Xm) | 0] = 48), (Tm = Qm)),
														(0 | Um) != (0 | Vm))
													) {
														if (!(Tm >>> 0 <= (16 + Xm) >>> 0))
															for (; (o[0 | (Tm = (Tm + -1) | 0)] = 48), (16 + Xm) >>> 0 < Tm >>> 0; );
								...
								(n[14] = function (a, Gl, Cm) {
									...
									for (
										...
										a: {
											if (
												((Jm = (Dm = 0) | K(q[(a + 60) >> 2], 0 | Gl, 0 | Lm, (12 + Em) | 0)) && ((q[2094] = Jm), (Dm = -1)),
								...
								}),
								{
									...
									p: function (a) {
										...
										return (
											(L = aj = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 540) >> 2] : ((q[(4 + aj) >> 2] = 1740), (q[aj >> 2] = 2402), Y(4, 1294, aj), -1)),
											(L = (16 + aj) | 0),
											0 | a
										);
									},
									...
									r: function (a) {
										...
										return (
											(L = _i = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 548) >> 2] : ((q[(4 + _i) >> 2] = 1740), (q[_i >> 2] = 2442), Y(4, 1294, _i), 0)),
											(L = (16 + _i) | 0),
											0 | a
										);
									},
									...
									v: function (a) {
										...
										return (
											(L = Wi = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 552) >> 2] : ((q[(4 + Wi) >> 2] = 1740), (q[Wi >> 2] = 2550), Y(4, 1294, Wi), 0)),
											(L = (16 + Wi) | 0),
											0 | a
										);
									},
									...
									x: function (a) {
										...
										return (
											(L = Ui = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 4) >> 2] : ((q[(4 + Ui) >> 2] = 1740), (q[Ui >> 2] = 2595), Y(4, 1294, Ui), -1)),
											(L = (16 + Ui) | 0),
											0 | a
										);
									},
									...
									z: function (a) {
										...
										return (
											(L = Si = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 52) >> 2] : ((q[(4 + Si) >> 2] = 1740), (q[Si >> 2] = 2625), Y(4, 1294, Si), 0)),
											(L = (16 + Si) | 0),
											0 | a
										);
									},
									...
									B: function (a) {
										...
										return (
											(L = Qi = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 332) >> 2] : ((q[(4 + Qi) >> 2] = 1740), (q[Qi >> 2] = 2673), Y(4, 1294, Qi), -1)),
											(L = (16 + Qi) | 0),
											0 | a
										);
									},
									...
									E: function (a) {
										...
										return (
											(L = Ni = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 432) >> 2] : ((q[(4 + Ni) >> 2] = 1740), (q[Ni >> 2] = 2739), Y(4, 1294, Ni), 0)),
											(L = (16 + Ni) | 0),
											0 | a
										);
									},
									...
									G: function (a) {
										...
										return (
											(L = Li = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 440) >> 2] : ((q[(4 + Li) >> 2] = 1740), (q[Li >> 2] = 2795), Y(4, 1294, Li), 0)),
											(L = (16 + Li) | 0),
											0 | a
										);
									},
									H: function (a) {
										...
										return (
											(L = Ki = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 436) >> 2] : ((q[(4 + Ki) >> 2] = 1740), (q[Ki >> 2] = 2820), Y(4, 1294, Ki), 0)),
											(L = (16 + Ki) | 0),
											0 | a
										);
									},
									I: function (a) {
										...
										return (
											(L = Ji = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 448) >> 2] : ((q[(4 + Ji) >> 2] = 1740), (q[Ji >> 2] = 2847), Y(4, 1294, Ji), 0)),
											(L = (16 + Ji) | 0),
											0 | a
										);
									},
									...
									M: function (a) {
										...
										return (
											(L = qi = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 444) >> 2] : ((q[(4 + qi) >> 2] = 1740), (q[qi >> 2] = 2943), Y(4, 1294, qi), 0)),
											(L = (16 + qi) | 0),
											0 | a
										);
									},
									...
									Q: function (a) {
										...
										return (
											(L = mi = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 452) >> 2] : ((q[(4 + mi) >> 2] = 1740), (q[mi >> 2] = 3045), Y(4, 1294, mi), 0)),
											(L = (16 + mi) | 0),
											0 | a
										);
									},
									R: function (a) {
										...
										return (
											(L = li = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 456) >> 2] : ((q[(4 + li) >> 2] = 1740), (q[li >> 2] = 3074), Y(4, 1294, li), 0)),
											(L = (16 + li) | 0),
											0 | a
										);
									},
									...
									T: function (a) {
										var ji;
										((L = ji = (L - 16) | 0),
											(a |= 0) ? (q[(a + 428) >> 2] = 1) : ((q[(4 + ji) >> 2] = 1740), (q[ji >> 2] = 3133), Y(4, 1294, ji)),
											(L = (16 + ji) | 0));
									},
									U: function (a) {
										var ii;
										return (
											(L = ii = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 640) >> 2] : ((q[(4 + ii) >> 2] = 1740), (q[ii >> 2] = 3162), Y(4, 1294, ii), 0)),
											(L = (16 + ii) | 0),
											0 | a
										);
									},
									V: function (a) {
										...
										return (
											(L = hi = (L - 16) | 0),
											(a = (a |= 0) ? q[(a + 636) >> 2] : ((q[(4 + hi) >> 2] = 1740), (q[hi >> 2] = 3187), Y(4, 1294, hi), 0)),
											(L = (16 + hi) | 0),
											0 | a
										);
									},
							...
							function Y(a, b, c) {
								var g;
								((L = g = (L - 272) | 0),
									t[1812] > a >>> 0 || ((a = q[1813]) && (Ka((16 + g) | 0, b, (q[(12 + g) >> 2] = c)), n[a]((16 + g) | 0))),
									(L = (272 + g) | 0));
							}
							function Z(a, b, c) {
								32 & r[0 | a] ||
							...
							function da(a, n) {
								...
								if (a >>> 0 < (n = (((a + n) | 0) - 1) | 0) >>> 0)
									for (
										;
										(p = r[0 | a]), (o[0 | a] = r[0 | n]), (o[0 | n] = p), (a = (a + 1) | 0) >>> 0 < (n = (n + -1) | 0) >>> 0;
									);
							}
							function ea(a) {
								var n,
							...
							function ga(a, q, v) {
								...
								if (x)
									for (
										;
										(o[0 | (v = (v + -1) | 0)] = (x - w((a = ((x >>> 0) / 10) | 0), 10)) | 48), (q = 9 < x >>> 0), (x = a), q;
									);
								return v;
							}
							function ha(a) {
								...
								a: if (a) {
									...
									b: if (!(1 & $)) {
										...
										if (((a = (a + $) | 0), q[2100] != (0 | ba)))
											...
											return ((q[2097] = a), (q[(4 + da) >> 2] = -2 & $), (q[(ba + 4) >> 2] = 1 | a), (q[(a + ba) >> 2] = a));
									}
												...
												16777215 < a >>> 0 ||
													...
													(v =
														(28 +
															(((v =
																((((v =
																	(v <<= ca = ((ca + 1048320) >>> 16) & 8) << (fa = ((v + 520192) >>> 16) & 4)) <<
																	(ea = ((v + 245760) >>> 16) & 2)) >>>
																	15) -
																	(ea | ca | fa)) |
																0) <<
							...
							function ua(a) {
								...
								if (
												...
												b: if (1 == q[md >> 2] && !((0 | (hd = q[(md + 40) >> 2])) < 1))
													if (((pd = ((a = q[(md + 36) >> 2]) + w(hd, 28)) | 0), (od = u[(md + 44) >> 2]), sd))
														for (;;) {
															nd = x((hd = 0));
															d: if (
																!((0 | (kd = q[a >> 2])) < 2 || ((jd = q[(a + 4) >> 2]), od <= (id = u[jd >> 2])))
															) {
																hd = 1;
																e: if (!(od < (ld = u[(jd + 4) >> 2]))) {
														...
														for (;;) {
															nd = x((kd = 0));
															c: if (
																!((0 | (qd = q[a >> 2])) < 2 || ((jd = q[(a + 4) >> 2]), od <= (id = u[jd >> 2])))
															) {
												...
												g: if ((0 | (ed = q[(Wc + 36) >> 2])) < 1) $c = x(1);
													...
													for (;;) {
														...
														l: if (
															...
															((Tc = x(x(Zc - _c) / x(Tc - _c))),
																(Tc = x(
																	x(Tc * u[(Vc = (Xc + (Vc << 2)) | 0) >> 2]) + x(u[(Vc + -4) >> 2] * x(x(1) - Tc))
																)));
														}
														if ((($c = $c < (u[(Uc + 16) >> 2] = Tc) ? $c : Tc), (0 | ed) == (0 | (a = (a + 1) | 0))))
															break;
													}
												}
												if (
									...
									for (
										...
										(_a = u[Aa >> 2]), (u[Aa >> 2] = _a < x(0) ? x(0) : x(A(_a, x(1)))), (Aa = (Aa + 4) | 0) >>> 0 < Ea >>> 0;
									);
								(!(function (a) {
									var Ce,
										De,
										...
										if (1 <= (0 | (sg = q[(a + 4) >> 2])))
											for (ug = q[(a + 8) >> 2], tg = q[a >> 2], vg = q[(tg + 724) >> 2]; ; ) {
												if (
													((og = q[(w(qg, 12) + ug) >> 2]),
													(q[(og + 28) >> 2] || q[(og + 24) >> 2]) &&
														((q[((mg = qg << 2) + q[(a + 28) >> 2]) >> 2] = q[(og + 12) >> 2]), q[(og + 24) >> 2]) &&
														!((0 | (pg = q[(og + 12) >> 2])) < 1))
												)
													for (
												...
												if (q[(og + 28) >> 2] && !((0 | (mg = q[(og + 12) >> 2])) < 1))
													for (
														pg = ((ng = q[(og + 20) >> 2]) + (mg << 2)) | 0, mg = (q[(a + 32) >> 2] + (rg << 2)) | 0;
														(q[mg >> 2] = q[ng >> 2]), (mg = (mg + 4) | 0), (ng = (ng + 4) | 0) >>> 0 < pg >>> 0;
													);
										...
										if (1 <= (0 | (Yf = q[(a + 56) >> 2]))) {
											for (Zf = q[(a + 60) >> 2], _f = q[(Vf + 1052) >> 2], $f = q[(Vf + 784) >> 2]; ; ) {
												if (
													((Rf = q[(Zf + w(Wf, 24)) >> 2]),
													(q[(Rf + 28) >> 2] || q[(Rf + 24) >> 2]) &&
														((q[((Sf = Wf << 2) + q[(a + 80) >> 2]) >> 2] = q[(Rf + 12) >> 2]), q[(Rf + 24) >> 2]) &&
														!((0 | (Uf = q[(Rf + 12) >> 2])) < 1))
												)
													for (
												...
												if (q[(Rf + 28) >> 2] && !((0 | (Sf = q[(Rf + 12) >> 2])) < 1))
													for (
														Uf = ((Tf = q[(Rf + 20) >> 2]) + (Sf << 2)) | 0, Sf = (q[(a + 84) >> 2] + (Xf << 2)) | 0;
														(q[Sf >> 2] = q[Tf >> 2]), (Sf = (Sf + 4) | 0), (Tf = (Tf + 4) | 0) >>> 0 < Uf >>> 0;
													);
										...
										if (1 <= (0 | (Hf = q[(a + 164) >> 2])))
											for (Jf = q[(wf + 816) >> 2]; ; ) {
												if (
													((xf = q[(w(Bf, 12) + Qf) >> 2]),
													(q[(xf + 28) >> 2] || q[(xf + 24) >> 2]) &&
														((q[((Cf = Bf << 2) + q[(a + 188) >> 2]) >> 2] = q[(xf + 12) >> 2]), q[(xf + 24) >> 2]))
												) {
												...
												if (q[(xf + 28) >> 2] && !((0 | (vf = q[(xf + 12) >> 2])) < 1))
													for (
														vf = ((uf = q[(xf + 20) >> 2]) + (vf << 2)) | 0, yf = (q[(a + 192) >> 2] + (Af << 2)) | 0;
														(q[yf >> 2] = q[uf >> 2]), (yf = (yf + 4) | 0), (uf = (uf + 4) | 0) >>> 0 < vf >>> 0;
													);
										...
										if (1 <= (0 | (ff = q[(a + 332) >> 2]))) {
											for (gf = q[(a + 336) >> 2], hf = q[($e + 1052) >> 2], jf = q[($e + 856) >> 2]; ; ) {
												if (
													((Ye = q[(gf + w(cf, 20)) >> 2]),
													(q[(Ye + 28) >> 2] || q[(Ye + 24) >> 2]) &&
														((q[((Ze = cf << 2) + q[(a + 356) >> 2]) >> 2] = q[(Ye + 12) >> 2]), q[(Ye + 24) >> 2]) &&
														!((0 | (af = q[(Ye + 12) >> 2])) < 1))
												)
													for (
												...
												if (q[(Ye + 28) >> 2] && !((0 | (Ze = q[(Ye + 12) >> 2])) < 1))
													for (
														af = ((_e = q[(Ye + 20) >> 2]) + (Ze << 2)) | 0, Ze = (q[(a + 360) >> 2] + (df << 2)) | 0;
														(q[Ze >> 2] = q[_e >> 2]), (Ze = (Ze + 4) | 0), (_e = (_e + 4) | 0) >>> 0 < af >>> 0;
													);
										...
										if (1 <= (0 | (Se = q[(a + 500) >> 2])))
											for (Ue = q[(a + 504) >> 2], Te = q[a >> 2], Ve = q[(Te + 1252) >> 2]; ; ) {
												if (
													((Oe = q[(w(Qe, 24) + Ue) >> 2]),
													(q[(Oe + 28) >> 2] || q[(Oe + 24) >> 2]) &&
														((q[((Me = Qe << 2) + q[(a + 524) >> 2]) >> 2] = q[(Oe + 12) >> 2]), q[(Oe + 24) >> 2]) &&
														!((0 | (Pe = q[(Oe + 12) >> 2])) < 1))
												)
													for (
												...
												if (q[(Oe + 28) >> 2] && !((0 | (Me = q[(Oe + 12) >> 2])) < 1))
													for (
														Pe = ((Ne = q[(Oe + 20) >> 2]) + (Me << 2)) | 0, Me = (q[(a + 528) >> 2] + (Re << 2)) | 0;
														(q[Me >> 2] = q[Ne >> 2]), (Me = (Me + 4) | 0), (Ne = (Ne + 4) | 0) >>> 0 < Pe >>> 0;
													);
									...
									(function (a) {
										...
										if (((L = Ck = (L - 16) | 0), (Ak = q[a >> 2]), !(r[(Ak + 4) | 0] < 5 || (0 | (Bk = q[(a + 596) >> 2])) < 1)))
											for (
												Fk = ((zk = q[(a + 600) >> 2]) + w(Bk, 12)) | 0, Gk = q[(a + 44) >> 2], Bk = q[(Ak + 976) >> 2];
												;
											) {
												...
												if (!((0 | (ri = q[(a + 612) >> 2])) < 1))
													for (
														...
														if (
															(f(0, ti),
															(wi = k()),
															(u[Di >> 2] = wi < x(9999999747378752e-20) ? x(9999999747378752e-20) : x(A(wi, x(100)))),
															!((si = (si + 12) | 0) >>> 0 < xi >>> 0))
														)
															break;
													}
									...
									(function (a) {
										...
										if (((L = Og = (L - 16) | 0), (Kg = q[a >> 2]), !(r[(Kg + 4) | 0] < 5 || (0 | (Mg = q[(a + 628) >> 2])) < 1)))
											for (
												Rg = ((Lg = q[(a + 632) >> 2]) + w(Mg, 12)) | 0, Sg = q[(a + 536) >> 2], Mg = q[(Kg + 1284) >> 2];
												;
											) {
										...
										if (1 <= (0 | (Ug = q[(a + 332) >> 2])))
											for (
												bh = ((Vg = q[(a + 336) >> 2]) + w(Ug, 20)) | 0,
													...
													_g = q[(a + 424) >> 2];
												q[_g >> 2] &&
													(-1 != (0 | (Zg = q[(Vg + 4) >> 2])) && (u[Ug >> 2] = u[((Zg << 2) + eh) >> 2] * u[Ug >> 2]),
													-1 != (0 | (Zg = q[(Vg + 8) >> 2]))) &&
												...
												for (Qc = q[(a + 436) >> 2], Lc = 0; ; ) {
													if (((Hc = (w(Lc, 28) + Pc) | 0), !(q[((Kc = Hc) + 24) >> 2] < 1))) {
														...
														if (!((0 | Ec) < 1))
															for (
																Ec = q[(a + 496) >> 2], Fc = 0;
																(q[(Ec + (Fc << 2)) >> 2] = -1), (0 | (Fc = (Fc + 1) | 0)) < q[(Kc + 24) >> 2];
															);
													}
													if (!(q[(Hc + 4) >> 2] < 1)) {
														for (
										...
										if (q[(a + 644) >> 2]) {
											if (!(((q[(a + 428) >> 2] = 0) | Cg) < 1))
												for (
													...
													(yg = 126),
														(Fg = (q[(a + 432) >> 2] + Ag) | 0),
														!q[((zg = Ag << 2) + q[(a + 424) >> 2]) >> 2] | (u[(zg + q[(a + 448) >> 2]) >> 2] == x(0)) ||
															(yg = 127),
														(o[0 | Fg] = yg),
														(0 | Cg) != (0 | (Ag = (Ag + 1) | 0));
												);
												...
												if (4 <= yg >>> 0)
													for (
														...
														(Eg = u[((yg = Ag << 2) + q[(a + 448) >> 2]) >> 2]),
															...
															(yg =
																q[(yg + q[(a + 436) >> 2]) >> 2] == q[(yg + q[(a + 460) >> 2]) >> 2] ? zg : 16 | zg),
															(yg = Bg ? 32 | yg : yg),
															(Bg = ((zg = Gg << 2) + q[(a + 452) >> 2]) | 0),
															(Dg = (zg + q[(a + 472) >> 2]) | 0),
															((u[Bg >> 2] != u[Dg >> 2]) |
																(u[(Bg + 4) >> 2] != u[(Dg + 4) >> 2]) |
																((u[(Bg + 8) >> 2] != u[(Dg + 8) >> 2]) | (u[(Bg + 12) >> 2] != u[(Dg + 12) >> 2])) ||
																((Bg = (zg + q[(a + 456) >> 2]) | 0),
																(zg = (zg + q[(a + 476) >> 2]) | 0),
																(u[Bg >> 2] != u[zg >> 2]) |
																	(u[(Bg + 4) >> 2] != u[(zg + 4) >> 2]) |
									...
									for (kb = (w(Wa, 12) + Xa) | 0; ; ) {
										if (!((0 | (ab = q[(Xa + 4) >> 2])) < 1))
											if (
												...
												for (
													;
													3 <= (ab = q[(Wa + 8) >> 2]) >>> 0 && ((q[(16 + cb) >> 2] = ab), Y(4, 1024, (16 + cb) | 0)),
														(Wa = (Wa + 48) | 0) >>> 0 < fb >>> 0;
												);
													...
													(Wa = (function (a, Gl, Hl) {
														...
														if (
															...
															if (
																...
																(q[(Zl + 444) >> 2] = Hl),
																!((0 | (mm = q[(Gl + 16) >> 2])) < 1) &&
																	((gm = (fm + q[(336 + lm) >> 2]) | 0), (q[Hl >> 2] = gm), (Hl = 1) != (0 | mm)))
															)
																for (
																	Gl = 0;
								...
								a: {
									b: if (!(1 & ($a = q[(a + 4) >> 2]))) {
										...
										if (((Za = (($a = q[a >> 2]) + Za) | 0), (0 | (a = (a - $a) | 0)) != q[2100]))
											...
											return ((q[2097] = Za), (q[(4 + nb) >> 2] = -2 & $a), (q[(a + 4) >> 2] = 1 | Za), (q[nb >> 2] = Za));
									}
									f: {
										if (!(2 & ($a = q[(4 + nb) >> 2]))) {
											if (q[2101] == (0 | nb)) {
											...
											16777215 < Za >>> 0 ||
												($a =
													(28 +
														((($a =
															((((nb =
																(mb <<= ob = ((mb + 1048320) >>> 16) & 8) << ($a = ((mb + 520192) >>> 16) & 4)) <<
																(mb = ((245760 + nb) >>> 16) & 2)) >>>
																15) -
																(mb | $a | ob)) |
															0) <<
									...
									b: {
										if ((j(a), (ub = 2147483647 & (tb = b[0])))) {
											...
											if (
												...
												(yb = x(
													u[1711] + x(x(x(sb - x(Za - xb)) * x(0.9617967009544373)) + x(Za * x(-0.00011736857413779944)))
												)),
										...
										d: {
											e: {
												...
												if (2139095040 != (0 | Gb)) {
													...
													if (
														((a = Ib = (Fb + 218103808) >>> 0 < Gb >>> 0 && ((Ib = x(0)), Jb) ? Ib : Ca(x(y(x(a / Db))))),
														Eb >>> 0 <= 2)
													) {
														switch ((Eb - 1) | 0) {
															case 0:
										...
										: 2139095040 <= Qb >>> 0
											...
											: ((Ub = Qb),
												...
												(Qb = (function (a, Gl, Hl) {
													...
													if (
														((L = Ll = (L - 560) | 0),
														(Pl = ((Jl = Hl) + w((Ul = 0 < (0 | (Hl = (((Hl + -3) | 0) / 24) | 0)) ? Hl : 0), -24)) | 0),
														0 <= (0 | (Ql = q[980])))
													)
														for (
															Jl = (Ql + 1) | 0, Hl = Ul;
															(v[(((320 + Ll) | 0) + (Kl << 3)) >> 3] = (0 | Hl) < 0 ? 0 : +q[(3936 + (Hl << 2)) >> 2]),
																(Hl = (Hl + 1) | 0),
																(0 | Jl) != (0 | (Kl = (Kl + 1) | 0));
														);
													for (Nl = (Pl + -24) | 0, Jl = 0; ; ) {
															...
															for (Kl = (Jl + Kl) | 0; ; ) {
																for (
																	Jl = Ol = (Jl + 1) | 0,
																		...
																		Il = Hl = 0;
																	(Il += v[((Hl << 3) + a) >> 3] * v[(((320 + Ll) | 0) + ((Ol - Hl) << 3)) >> 3]),
																		1 != (0 | (Hl = (Hl + 1) | 0));
																);
												...
												for (
													...
													(jp =
														((np = mp = (jp << 1) | (ap >>> 31)) -
															(op =
																bp &
																(mp = (hp - (((ip = (ip << 1) | (jp >>> 31)) + (lp >>> 0 < mp >>> 0)) | 0)) >> 31))) |
														0),
														(ip = (ip - (np >>> 0 < op >>> 0)) | 0),
														(ap = (ap << 1) | (a >>> 31)),
														(a = pp | (a << 1)),
									...
									if (null != a && 0 !== a) {
										...
										if (0 < d) {
											for (var d = e + d - 1, g = 0; g < a.length; ++g) {
												...
												if (
													(k = 55296 <= k && k <= 57343 ? (65536 + ((1023 & k) << 10)) | (1023 & a.charCodeAt(++g)) : k) <=
													127
												) {
													if (d <= e) break;
													f[e++] = k;
